...
class BuffMachine:
    EFFECTS = {
        "buff1": ("x1.1 ������ ������ 10 ������ �� ���������� ������!", "buff", 60000, 10000, 1.1, "clicks"),
        "buff2": ("���� ������������� �� 2 �� 10 ������!", "buff", 10000, 0, 2, "boost_bonus"),
        "buff3": ("x3 NamaCoins �� �����!", "buff", 60000, 0, 3, "farm_coins"),
        "debuff1": ("-10 ������ ������ 3 ������� �� ���������� 30 ������!", "debuff", 30000, 3000, -10, "clicks"),
        "debuff2": ("� NamaPass � �������� ����������� ������� ����������� 30 ������!", "debuff", 0, 0, 30000, "namapass_delay"),
        "debuff3": ("NamaCoins ������� �� 2", "debuff", 0, 0, 0, "halve_coins"),
    }
...
cfa_collect_all_tamas = Achievements("������� ��� NamaTama", 64, 80)
cfa_sanic_popout = Achievements("��������� Sanic", 372, 80)
cfa_IT = Achievements("��������� ...", 679, 80)
cfa_1000_clicks = Achievements("������� 1000 ������", 65, 382)
cfa_10000_clicks = Achievements("������� 10000 ������", 372, 382)
cfa_1000000_clicks = Achievements("������� 1000000 ������", 679, 382)
...
while running:
    ...
    if mode == "game":
        ...
        if buffm_intermission_timer.done():
            ...
            machine_timer_text = f"������: {buffm_intermission_timer.time_format()}"
        screen.blit(
        ...
        effect_color = WHITE
        effect_title = "������:"
        effect_text = buffm.last_result_text if buffm.last_result_text else "���� ��� �������"
        ...
        if show_buff_effect_end_notice:
            screen.blit(
                font_20.render("������ ��������", True, (255, 245, 140)),
        ...
        if buffm.active_effect_id is not None and buffm.active_effect_timer is not None:
            screen.blit(
                font_20.render(f"�� �����: {buffm.active_effect_timer.time_format()}", True, effect_color),
        ...
        if boost >= 50:
            ...
            screen.blit(
                font_30.render(f"����: x{boost + 1}", True, BLACK),
                (55, 650)
            )

        screen.blit(
            font_25.render(f"����: {int(required_clicks_for_boost)}", True, BLACK),
            (56, 676)
        )
        ...
        if show_intro_game_text:
            screen.blit(
                font_25.render("Namatama �������� ������ ����", True, WHITE),
                (300, 700),
            )
    ...
    if mode == "exchanger":
        ...
        screen.blit(
            font_40.render("����� > NamaCoins", True, BLACK),
            (320, 230)
        )
        screen.blit(
            font_40.render("NamaCoins > �����", True, BLACK),
    ...
    if mode == "backgrounds_shop":
        ...
        if seoul_bg.isBought:
            status_text_seoul = "������" if not seoul_bg.equipped else "�����"
            screen.blit(
                font_25.render(f"�������. {status_text_seoul}", True, BLACK),
                (seoul_bg.button_rect.x, seoul_bg.button_rect.bottom + 10)
            )
        else:
            screen.blit(
                font_25.render(f"����: {seoul_bg.price} NamaCoins", True, BLACK),
                (seoul_bg.button_rect.x, seoul_bg.button_rect.bottom + 10)
            )

        kyoto_bg.draw_button(screen)
        if kyoto_bg.isBought:
            status_text_kyoto = "������" if not kyoto_bg.equipped else "�����"
            screen.blit(
                font_25.render(f"�������. {status_text_kyoto}", True, BLACK),
                (kyoto_bg.button_rect.x, kyoto_bg.button_rect.bottom + 10)
            )
        else:
            screen.blit(
                font_25.render(f"����: {kyoto_bg.price} NamaCoins", True, BLACK),
                (kyoto_bg.button_rect.x, kyoto_bg.button_rect.bottom + 10)
            )

        bernal_bg.draw_button(screen)
        if bernal_bg.isBought:
            status_text_bernal = "������" if not bernal_bg.equipped else "�����"
            screen.blit(
                font_25.render(f"�������. {status_text_bernal}", True, BLACK),
                (bernal_bg.button_rect.x, bernal_bg.button_rect.bottom + 10)
            )
        else:
            screen.blit(
                font_25.render(f"����: {bernal_bg.price} NamaCoins", True, BLACK),
                (bernal_bg.button_rect.x, bernal_bg.button_rect.bottom + 10)
            )
