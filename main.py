...
kiro_phrases = [
    "Рђ С‚СѓС‚, РєСЂР°СЃРёРІРѕ...",
    "РЇ СЃС‚РѕР»СЊРєРѕ Р»РµС‚ Р±С‹Р» С‚Р°Рј...",
    "РћРЅ РёСЃС‡РµР·.",
    "РЈ РЅРµРіРѕ Р±С‹Р»Р° С†РµР»Р°СЏ РєРѕР»Р»РµРєС†РёСЏ РєРѕРјРёРєСЃРѕРІ!",
    "...РњРЅРµ Р±С‹Р»Рѕ РѕС‡РµРЅСЊ Р±РѕР»СЊРЅРѕ.",
]
ronald_phrases = [
    "РћРіРѕ! РўР°Рє РІРѕС‚ РєР°РєРѕР№ СЌС‚РѕС‚ РјРёСЂ РЅР° РїРѕРІРµСЂС…РЅРѕСЃС‚Рё!",
    "Р—РґРµСЃСЊ С‚Р°РєР°СЏ Р·РµР»С‘РЅР°СЏ Рё СЏСЂРєР°СЏ С‚СЂР°РІР°!",
    "РҐРѕС‚СЊ РјРЅРµ Рё 25, РІ РґСѓС€Рµ СЏ РІСЃС‘ С‚Р°РєРѕР№-Р¶Рµ СЃРѕСЂРІР°РЅРµС†.",
    "Р§С‚Рѕ РµСЃР»Рё РјС‹ Р¶РёРІС‘Рј РІ РЅСѓР»СЏС… Рё РµРґРёРЅРёС†Р°С…?",
    "РќР°СЃ СЃРґРµР»Р°Р» ChatGPT..."
]
oshu_phrases = [
    "РњС…Рј... С‚Р°Рє РЅРµ РїСЂРёСЏС‚РЅРѕ, РєРѕРіРґР° СЃРѕР»РЅС†Рµ Р±СЊС‘С‚ РїСЂСЏРјРѕ РІ РіР»Р°Р·Р°!",
    "РњРѕРё РґСЂСѓР·СЊСЏ... РћРЅРё... Р—Р°Р±РµР№.",
    f"Р¦РµРЅРё РґСЂСѓР·РµР№, {os.getlogin()}.",
